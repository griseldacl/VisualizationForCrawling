...
//        }
    ...
    public synchronized DestAddress getRouting( GUID guid )
    {
        ...
        address = ( DestAddress )currentMap.get( guid );
        if( address != null )
        {
            return address;
        }
        ...
        address = ( DestAddress )lastMap.get( guid );
        if( address != null )
        {
            return address;
        }
    ...
    public synchronized DestAddress getAndRemoveRouting( GUID guid )
    {
        ...
        // first check in the current map
        address = ( DestAddress )currentMap.remove( guid );
        if( address != null )
        {
            return address;
        }
        ...
        // now check in the last map
        address = ( DestAddress )lastMap.remove( guid );
        if( address != null )
        {
            return address;
        }
