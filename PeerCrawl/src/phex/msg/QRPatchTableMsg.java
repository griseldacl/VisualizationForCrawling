...
public class QRPatchTableMsg extends RouteTableUpdateMsg
{
        ...
        throws IOException
    {
        ...
        outStream.write( sequenceNumber );
        outStream.write( sequenceSize );
        outStream.write( compressor );
        outStream.write( entryBits );
        outStream.write( data, dataOffset, dataLength );
    }
}