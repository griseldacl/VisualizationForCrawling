 ...
 * 
 *  --- CVS Information ---
 *  $Id: GnutellaInputStream.java,v 1.24 2005/11/03 00:58:21 gregork Exp $
 */
package phex.utils;
...
//        }
    ...
    protected void fill() throws IOException
    {
        ...
        {// InflaterInputStream throws EOFException if underlying InputStream
         // reads data amount of -1. We dont like to forward this exception
         // instead we just dont fill buffer.
            return;
        }
    }
}