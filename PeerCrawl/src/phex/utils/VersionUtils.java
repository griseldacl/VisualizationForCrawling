...
public class VersionUtils
{
    ...
    static
    {
        ...
        try
        {
            ...
            majorStr = version.substring( firstIdx + 1, secondIdx );
            minorStr = version.substring( secondIdx + 1, thirdIdx );
        }
        ...
        MAJOR_VERSION_NUMBER = new Integer( majorStr ).intValue();
        MINOR_VERSION_NUMBER = new Integer( minorStr ).intValue();
    }
