 ...
 *  --- CVS Information ---
 *  $Id: SystemShellExecute.java,v 1.1 2005/10/27 22:13:28 gregork Exp $
 */
package phex.utils;
...
public class SystemShellExecute
{
        ...
        throws IOException
    {
        ...
        {
            commandStr = ServiceManager.sCfg.otherOsVideoCommand;
        }
        else if ( MediaType.getImageMediaType().isFilenameOf(filepath) )
        {
            commandStr = ServiceManager.sCfg.otherOsImageCommand;
        }
        else if ( MediaType.getAudioMediaType().isFilenameOf(filepath) )
        {
            commandStr = ServiceManager.sCfg.otherOsAudioCommand;
        }
        else
        {
            commandStr = ServiceManager.sCfg.otherOsBrowserCommand;
        }
