...
public class ResearchService
{
    ...
    public ResearchService( ResearchServiceConfig config )
    {
    ...
    public void startResearchSequence()
    {
        ...
        for ( int i = swarmingMgr.getDownloadFileCount(); i >= 0; i-- )
        {
            SWDownloadFile file = swarmingMgr.getDownloadFile( i );
            if ( file != null )
            {
...
*/
        ...
        {
            // we dont search when download is in progress, completed or stopped
            return;
        }
    ...
    /**
     * Unfortunatly we need the DownloadFile also for better optimization.
     */
        ...
        SWDownloadFile downladFile )
    {
        ...
        // current timestamp for performence reason..
