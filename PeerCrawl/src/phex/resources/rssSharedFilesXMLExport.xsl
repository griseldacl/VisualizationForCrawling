...
-->
		<admin:generatorAgent rdf:resource="http://phex.kouk.de" />
		<admin:errorReportsTo rdf:resource="mailto:phex@kouk.de"/>
<!--
...
-->
	...
	<item>
		...
		<magnet><xsl:apply-templates select="magnet-url"/></magnet>
    </item>
    </xsl:for-each>
	</channel>
	</rss>
