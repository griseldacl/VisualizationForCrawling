  ...
  <xsl:template match="/shared-file-export">
    <html>
      ...
      <tr valign="top"><td class="bodyline">
          ...
          <tr>
            ...
            <td bgcolor="#DD6900"><b>Magnet</b></td>
      		...
      		<tr>
      		  ...
      		  <td class="cell"><xsl:apply-templates select="magnet-url"/></td>
      		</tr>
      		</xsl:for-each>
        </table>
        </td></tr></table>
        ...
        <center><div>Copyright 2004 Gregor Koukkoullis - All Rights Reserved.</div>
        <div><a href="http://phex.kouk.de">
