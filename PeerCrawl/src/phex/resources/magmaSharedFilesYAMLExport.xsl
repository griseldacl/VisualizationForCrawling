...
list:<xsl:for-each select="shared-file-list/shared-file">
 ...
 - "magnet:?xt=<xsl:apply-templates select="urn"/>
   &amp;dn=<xsl:value-of select="name-urlenc"/><xsl:if test="/shared-file-export/export-options/option[@name='UseMagnetURLWithXS'] = 'true'">
...
# Phex: Copyright 2004 Gregor Koukkoullis - All Rights Reserved.
# Link: http://phex.kouk.de
