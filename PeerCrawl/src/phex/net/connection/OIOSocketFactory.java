...
public final class OIOSocketFactory
{
    ...
    public static SocketFacade connect( DestAddress address ) 
        throws IOException
    {
        return connect( address, ServiceManager.sCfg.socketConnectTimeout,
            null );
    }
        ...
        throws IOException
    {
        ...
        try
        {
            socket = createSocket( new DefaultDestAddress( ServiceManager.sCfg.mProxyHost,
                    ServiceManager.sCfg.mProxyPort ), 
                    ServiceManager.sCfg.socketConnectTimeout, acquireCallback );
