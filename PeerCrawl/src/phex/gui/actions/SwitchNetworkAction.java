 ...
 * 
 *  --- CVS Information ---
 *  $Id: SwitchNetworkAction.java,v 1.9 2005/10/03 00:18:25 gregork Exp $
 */
...
public class SwitchNetworkAction extends FWAction
{
    ...
    public SwitchNetworkAction( )
    {
        super( Localizer.getString( "SelectNetwork" ),
            GUIRegistry.getInstance().getIconFactory().getIcon( "Join" ),
            Localizer.getString( "TTTSelectNetwork" ), new Integer(
