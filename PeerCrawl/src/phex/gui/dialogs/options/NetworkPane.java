 ...
 * 
 *  --- CVS Information ---
 *  $Id: NetworkPane.java,v 1.35 2005/11/04 20:42:23 gregork Exp $
 */
...
public class NetworkPane extends OptionsSettingsPane
{
    ...
    protected void prepareComponent()
    {
        ...
        maxConcurrentConnectAttemptsTF = new IntegerTextField(
            String.valueOf( ServiceManager.sCfg.maxConcurrentConnectAttempts ), 2, 2 );
        ...
        leaf2upConnectionsTF = new IntegerTextField(
            String.valueOf( ServiceManager.sCfg.leaf2upConnections ), 2, 1 );
    ...
    public void checkInput( HashMap inputDic )
    {
        ...
        try
        {
            ...
            if ( leaf2upConn.intValue() > Cfg.MAX_LEAF_2_UP_CONNECTIONS )
            {
    ...
    public void displayErrorMessage( HashMap inputDic )
    {
        ...
        {
            leaf2upConnectionsTF.setText(String.valueOf( Cfg.MAX_LEAF_2_UP_CONNECTIONS ) );
            ...
            JOptionPane.showMessageDialog( this,
                Localizer.getFormatedString( "NetworkSettings_Leaf2UpLimitExceeded",
                    new Object[] {new Integer(Cfg.MAX_LEAF_2_UP_CONNECTIONS)} ),
                Localizer.getString( "NetworkSettings_LimitExceeded" ),
                JOptionPane.ERROR_MESSAGE  );
        }
        else if ( inputDic.containsKey( LISTENING_PORT_EXCESS_ERROR_KEY ) )
        {
            listeningPortTF.setText( String.valueOf( ServiceManager.sCfg.mListeningPort ) );
    ...
    public void saveAndApplyChanges( HashMap inputDic )
    {
        ...
        int maxConcurrentConnectAttempts = maxConcurrentConnectAttemptsInt.intValue();
        if ( ServiceManager.sCfg.maxConcurrentConnectAttempts != maxConcurrentConnectAttempts )
        {
