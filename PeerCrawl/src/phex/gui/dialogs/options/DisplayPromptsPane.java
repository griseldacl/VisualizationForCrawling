 ...
 * 
 *  --- CVS Information ---
 *  $Id: DisplayPromptsPane.java,v 1.9 2005/10/03 00:18:26 gregork Exp $
 */
...
public class DisplayPromptsPane extends OptionsSettingsPane
{
    ...
    protected void prepareComponent()
    {
        ...
        showCloseOptionsChkbx = new JCheckBox(
            ...
            ServiceManager.sCfg.showCloseOptionsDialog );
        ...
        showBetaUpdateNotificationChkbx = new JCheckBox(
            ...
            ServiceManager.sCfg.showBetaUpdateNotification );
    ...
    public void saveAndApplyChanges( HashMap inputDic )
    {
        ...
        if ( ServiceManager.sCfg.showBetaUpdateNotification != betaUpdateNotify )
        {
