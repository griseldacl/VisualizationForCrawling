 ...
 * 
 *  --- CVS Information ---
 *  $Id: SearchResultElementComparator.java,v 1.9 2005/10/08 17:35:54 gregork Exp $
 */
 ...
 * 
 */
public class SearchResultElementComparator implements Comparator
{
    ...
    public void setSortField( int sortField, boolean isSortedAscending )
    {
        ...
        hostAddressComparator = new HostAddressComparator();
    }
    ...
    public int compare(Object obj1, Object obj2)
    {
        ...
        SearchResultElement sr1 = (SearchResultElement)obj1;
        SearchResultElement sr2 = (SearchResultElement)obj2;
        ...
        switch ( sortField )
        {
            ...
            case SORT_BY_HOST:
                ...
                {
                    diff = hostAddressComparator.compare(
            ...
            case SORT_BY_SPEED:
                if ( sr1.getRemoteFileListCount() == 0 && sr2.getRemoteFileListCount() == 0 )
                {
                    diff = sr1.getSingleRemoteFile().getQueryHitHost().getHostSpeed() -
                        sr2.getSingleRemoteFile().getQueryHitHost().getHostSpeed();
                }
                else
                {
                    diff = sr1.getRemoteFileListCount() - sr2.getRemoteFileListCount();
            ...
            case SORT_BY_SCORE:
                if ( sr1.getRemoteFileListCount() == 0 && sr2.getRemoteFileListCount() == 0 )
                {
                    diff = sr1.getSingleRemoteFile().getScore().shortValue() -
        ...
        {   // diff is 0 we need to determine a difference value that stays unique on
            // consequitive calls. Using a hashCode sounds reasonable though it might
            // still result to 0...
