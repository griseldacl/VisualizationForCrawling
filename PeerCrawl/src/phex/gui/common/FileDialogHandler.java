 ...
 *  --- CVS Information ---
 *  $Id: FileDialogHandler.java,v 1.9 2005/10/28 14:22:48 gregork Exp $
 */
...
public class FileDialogHandler
{
        ...
        File currentDirectory )
    {
        if ( SystemUtils.IS_OS_MAC_OSX )
        {
            return new File[]
            {
                openMacDirectoryChooser( title, null, null )
            };
        }
        else
        {
        
            return openDefaultChooser( parent, title, approveBtnText, approveBtnMnemonic, 
    ...
    public static File[] openMultipleDirectoryChooser( Component parent, 
        String title, String approveBtnText, char approveBtnMnemonic,
        File currentDirectory, String notifyPopupTitle, String notifyPopupShortMessage )
    {
        if ( SystemUtils.IS_OS_MAC_OSX )
        {
            return new File[]
    ...
    private static File[] openDefaultChooser( Component parent, String title,
