 ...
 * 
 *  --- CVS Information ---
 *  $Id: DialogBanner.java,v 1.7 2005/10/03 00:18:25 gregork Exp $
 */
...
public class DialogBanner extends JPanel
{
    ...
    public DialogBanner( String aHeaderText, String aSubHeaderText )
    {
        ...
        image = GUIRegistry.getInstance().getIconFactory().getIcon( "PhexWizard" );
    ...
    public void setImageIcon( String imageKey )
    {
        if ( imageKey != null )
        {
            this.image = image = GUIRegistry.getInstance().getIconFactory().getIcon( imageKey );
        }
        else
        {
            this.image = null;
