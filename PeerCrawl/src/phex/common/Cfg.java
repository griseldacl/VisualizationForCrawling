 ...
 * 
 *  --- CVS Information ---
 *  $Id: Cfg.java,v 1.102 2005/11/19 16:41:08 gregork Exp $
 *  File Modified
 */
...
public class Cfg
{
     ...
     */
    public final static String PRIVATE_NETWORK = "PeerCrawl";
    public final static String PRIVATE_BUILD_ID = "2.0"; 
     ...
     */
    public static final boolean DEFAULT_FORCE_TOBE_ULTRAPEER = true;
    ...
    public static final boolean DEFAULT_ALLOW_TO_BECOME_LEAF = false;
...
//    public int					mListeningPort = -1;
    public int					mListeningPort = 8000;
     ...
     *   
     */
    public static final String UPDATE_URI_MAC_OSX = "magnet:?xs=http://draketo.de/dateien/phex_osx.magma&dn=phex_osx.magma";
    public static final String UPDATE_URI_WINDOWS = "magnet:?xs=http://draketo.de/dateien/phex_win.magma&dn=phex_win.magma";
    public static final String UPDATE_URI_OTHER = "magnet:?xs=http://draketo.de/dateien/phex_other.magma&dn=phex_other.magma";
    ...
    public static final String default_streamableSuffixes = new String("avi|mpe?g|asf|wmv|ogm|ogg|mp3|mov|txt|html?|rtf|lit");
