 ...
 *  --- CVS Information ---
 *  $Id: FileManager.java,v 1.2 2005/10/19 15:50:32 gregork Exp $
 */
...
//        }
        ...
        throws ManagedFileException
    {
        ...
        managedFile.setAccessMode( ManagedFile.READ_WRITE_ACCESS );
        return managedFile;
    }
    ...
    {
        ManagedFile managedFile = getManagedFile( file );
        managedFile.setAccessMode( ManagedFile.READ_ONLY_ACCESS );
        return managedFile;
    }
    ...
    private void initOpenFileTracking()
    {
        ...
        synchronized( this )
        {
            if ( openFileMap == null )
            {
                openFileMap = new LinkedHashMap( ServiceManager.sCfg.openFilesLimit, 
                    0.75f, true );
            }
        }
    }
