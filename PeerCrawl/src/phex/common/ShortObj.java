 ...
 * 
 *  --- CVS Information ---
 *  $Id: ShortObj.java,v 1.4 2005/10/03 00:18:22 gregork Exp $
 */
package phex.common;

/**
 * Class that is similar to <code>Short</code> but is mutable.
 */
public class ShortObj extends Number implements Comparable
{
    public short value;
    ...
    public boolean equals( Object o )
    {
        ...
        else if ( ! ( o instanceof ShortObj ) )
        {
            return false;
        }
        return value == ((ShortObj)o).value;
    }
     ...
     *       comparison).
     */
    public int compareTo(ShortObj anotherShortObj)
    {
        int thisVal = this.value;
        int anotherVal = anotherShortObj.value;
