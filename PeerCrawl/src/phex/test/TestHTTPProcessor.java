 ...
 * 
 *  --- CVS Information ---
 *  $Id: TestHTTPProcessor.java,v 1.7 2005/10/03 00:18:29 gregork Exp $
 */
package phex.test;
...
public class TestHTTPProcessor extends TestCase
{
    ...
    {
        InputStream inStream = new ByteArrayInputStream( fullHTTPRequest.getBytes() );
        GnutellaInputStream inStream1 = new GnutellaInputStream( inStream );
        
        Connection connection = new Connection(null, null);
        AccessUtils.setFieldValue( connection, "inputStream", inStream1 );
        try
        {
